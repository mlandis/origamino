...
public: 
		  ...
		  inline MbMatrix   &ref(const MbMatrix &A);                          //!< creates a reference to another matrix (shallow copy) 
                 ...
                 MbMatrix   &inject(const MbMatrix &A);                       //!< copy the values of elements from one matrix to another 
					 ...
					 void   setIdentity(void);                                //!< sets the matrix to the identity matrix
 ...
 */
template <class T>
MbMatrix<T>::MbMatrix(void) : v(0), m(0), n(0), refCount(0), cArray(false) {
 ...
 */
template <class T>
MbMatrix<T>::MbMatrix(int m, int n) : v(0), m(0), n(0), refCount(0), cArray(false) {
...
template <class T>
void MbMatrix<T>::setIdentity(void) {
